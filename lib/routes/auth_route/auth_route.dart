...
import 'package:crud_app/ui/pages/login_signup_page/login_signup_page.dart';
...
class AuthRoute extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, AuthStatus>(
      distinct: true,
      onInitialBuild: (AuthStatus authStatus) =>
          _checkAuthStatus(context, authStatus),
      onDidChange: (AuthStatus authStatus) =>
          _checkAuthStatus(context, authStatus),
